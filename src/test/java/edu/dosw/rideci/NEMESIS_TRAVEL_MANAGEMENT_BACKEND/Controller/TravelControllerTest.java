package edu.dosw.rideci.NEMESIS_TRAVEL_MANAGEMENT_BACKEND.Controller;
...
class TravelControllerTest {
    ...
    void shouldCreateTravelSuccessfully() throws Exception {
        ...
        when(createTravelUseCase.createTravel(any(Travel.class))).thenReturn(travelDomain);
        ...
        verify(createTravelUseCase, times(1)).createTravel(any(Travel.class));
    }
