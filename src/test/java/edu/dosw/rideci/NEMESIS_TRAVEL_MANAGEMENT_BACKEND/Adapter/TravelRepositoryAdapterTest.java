package edu.dosw.rideci.NEMESIS_TRAVEL_MANAGEMENT_BACKEND.Adapter;
...
class TravelRepositoryAdapterTest {
    ...
    void shouldSaveTravelSuccessfully() {
        ...
        when(travelMapper.toDocument(any(Travel.class))).thenReturn(travelDocument);
        ...
        verify(travelMapper, times(1)).toDocument(any(Travel.class));
